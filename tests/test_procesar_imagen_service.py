...
@patch("app.services.procesarImage_services.obtener_algoritmo_por_nombre")
@patch("app.services.procesarImage_services.obtener_imagen_por_id")
def test_procesar_reduccion_ruido(mock_imagen,mock_algoritmo,mock_crear,mock_procesador):
...
@patch("app.services.procesarImage_services.obtener_algoritmo_por_nombre")
@patch("app.services.procesarImage_services.obtener_imagen_por_id")
def test_procesar_brillo(mock_imagen,mock_algoritmo,mock_crear,mock_procesador):
...
@patch("app.services.procesarImage_services.obtener_algoritmo_por_nombre")
@patch("app.services.procesarImage_services.obtener_imagen_por_id")
def test_procesar_blanco_negro(mock_imagen,mock_algoritmo,mock_crear,mock_procesador):
...
@patch("app.services.procesarImage_services.obtener_algoritmo_por_nombre")
@patch("app.services.procesarImage_services.obtener_imagen_por_id")
def test_procesar_restauracion(mock_imagen,mock_algoritmo,mock_crear,mock_procesador):
...
@patch("app.services.procesarImage_services.obtener_algoritmo_por_nombre")
@patch("app.services.procesarImage_services.obtener_imagen_por_id")
def test_procesar_imagen_corrupta(mock_imagen,mock_algoritmo,mock_crear,mock_procesador):
...
@patch("app.services.procesarImage_services.obtener_algoritmo_por_nombre")
@patch("app.services.procesarImage_services.obtener_imagen_por_id")
def test_se_registra_procesamiento(mock_imagen,mock_algoritmo,mock_crear,mock_procesador):
